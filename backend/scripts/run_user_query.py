...
LEFT JOIN massive.splits s ON d.ticker = s.ticker AND d.trade_date = s.execution_date
LEFT JOIN massive.etf e ON d.ticker = e.ticker
...
print("Executing user's exact query...")
