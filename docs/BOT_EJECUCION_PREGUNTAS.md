...
23. **[API] Órdenes DURANTE un halt: ¿DAS acepta por el API una orden a mercado (o límite) mientras la acción está parada y la envía al cruce de reapertura? ¿Se puede cancelar antes de la reapertura? ¿Qué devuelve?***