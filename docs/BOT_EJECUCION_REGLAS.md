...
**Caso real SLGB 9-jun-2026 (mismo script, TK=SLGB):** máximo del PM 1,40 a las 06:23; entrada 5 % por debajo (1,33, tocado). Fogonazo 06:33:03-06:33:59 de 1,36 a 12,66 (+852 % sobre la entrada); el ask pasó de 1,47 a 5,00 en el mismo segundo del disparo del principal (1,463) y a 13,30 en el minuto; libro Nasdaq 5,7 k$ en el disparo, 619 k$ en el pico. Principal: 0 llenas. Emergencia (1,66 / límite 2,49): llena TODO en la bajada a 1,83-2,17 de media según tamaño (751 a 37.593 acciones): pérdida 37 % del trade (3,7 % de la cuenta, 10 k) a 63 % (6,3 %, 100 k); 54 % con 500 k. Mínimo del ask en 30 min: 1,19 (bajo la entrada). Negociado en 30 min: 233 k acciones, 599 k $.
**Conclusión de los tres casos reales (AEMD, PLYX, SLGB):** en un fogonazo de verdad NUNCA se sale en la subida: el ask salta los dos triggers en el mismo segundo y el principal no coge nada; la salida la da SIEMPRE la emergencia en la bajada, dentro de su límite del +50 %, en todos los tamaños probados (hasta 500 k-2 M de cuenta), con pérdidas del 37-75 % del trade (3,7-7,5 % de la cuenta con posición del 10 %; 1,1-2,3 % con posición del 3 %).
