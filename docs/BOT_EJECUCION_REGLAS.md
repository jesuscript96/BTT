...
**Estudio por tamaño sobre TODOS los fogonazos con libro (`40_fogonazos_por_tamano.py`, 20-sep): 39 fogonazos 2022-2026 (28 con salto ≥ 100 %, 11 de 50-100 %) con libro Nasdaq de 10 niveles y 30 min tras el pico.** Corto abierto ANTES del fogonazo al último precio, posición 10 % de la cuenta, stops del libro, latencia DAS 200 ms, fotos de 100 ms, 100 % de lo mostrado al llegar la orden y 50 % en cada foto posterior.
...
|---|---|---|---|---|---|
| 10 k | 92 % | 8 % | 0 % | 2,9 / 2,3 / 5,7 / 7,9 % | 23 / 57 % |
| 20 k | 92 % | 8 % | 0 % | 2,9 / 2,5 / 5,7 / 7,9 % | 25 / 57 % |
| 50 k | 85 % | 15 % | 0 % | 3,1 / 2,7 / 5,8 / 7,9 % | 27 / 58 % |
| 100 k | 79 % | 21 % | 0 % | 3,4 / 3,3 / 6,4 / 7,9 % | 33 / 64 % |
| 500 k | 74 % | 26 % | 0 % | 3,6 / 3,5 / 6,6 / 7,5 % | 35 / 66 % |
Lecturas: (1) en NINGUNO de los 39 quedó residuo a los 30 min: la emergencia (límite ≈ +86 % sobre la entrada) se ejecutó siempre, también en ENSC (+4.836 %), CIIT (+4.450 %) y XHG; (2) la salida es en la subida en la gran mayoría con cuentas pequeñas y baja al 74 % con 500 k (a más tamaño, más se completa en la bajada); (3) la pérdida sobre la cuenta con el 10 % por posición: media ≈ 3 %, peor 10 % ≈ 6 %, máximo 7,9 % (ENSC); con el 3 % por posición, dividir por 3,3: media ≈ 0,9 %, máximo ≈ 2,4 %; (4) los peores (> 5 % de la cuenta) son fogonazos en los que la emergencia compra cerca de su límite: ENSC, CIIT, BSFC, IMAC, VACC, APLM, DWSN, ZEO, SLGB. Cautelas: libro solo Nasdaq (el consolidado tiene más liquidez: resultados conservadores), fotos de 100 ms, consumo del 50 % por foto durante hasta 30 min (generoso para tamaños grandes), latencia fija de 200 ms (medir la real en sombra), 39 casos.
