...
- **Estado:** hecho en el worktree `D:\Backtester-bswan` (rama local `bswan-dev`) porque el bot estaba en vivo. **PENDIENTE integrar en `sailor-rama-desarrollo` y reiniciar el backend con el bot parado** (receta en `MEMORIA.md` §22.8). No subido.
