...
- **Estado:** `9e11fa8` en `scalping-dev` (worktree `D:\Backtester-scalping`), hecho con el bot vivo sin tocar `D:\Backtester`. Fusión a `sailor-rama-desarrollo` pendiente de la autorización de Jaume (recarga el backend).
