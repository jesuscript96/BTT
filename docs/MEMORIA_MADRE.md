...
- **Lo que queda:** el gráfico no pinta las ejecuciones (`escalera_executions` viaja en el trade, sin consumidor en la UI); sin probar con piramidación y parciales a la vez; el bot no lo usará (decisión de Jaume).
