...
- **NO integrados (a propósito, no eran piramidación):** su visor modal de trade (3575d3a) y el fix «Config. Estrategia guardada abre la estrategia anterior» (70ff4d7) — este último SÍ nos pasa (visto hoy en sailor: abre la anterior). Están en su rama, se pueden traer cuando Jaume quiera.
