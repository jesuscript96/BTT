...
| P15 | **PRIMERA PRUEBA al tener el API de DAS (Jaume, 21-sep):** construir las velas de los tickers del radar desde el Time & Sales de DAS y, en paralelo, desde los ticks (T/Q) de Massive; comparar vela a vela hasta paridad exacta (sombra y canario). Manda DAS por rapidez si se puede. Motivo: el canal A de Massive llega a 3,4 s; T/Q a 0,7 s; DAS ≈ 0,1-0,3 s. Regla R-A-06; preguntas R-18/R-19. | Espera API |
