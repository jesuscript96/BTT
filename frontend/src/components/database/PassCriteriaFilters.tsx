    ...
    return (
        <div className="space-y-4">
            <div className="flex items-center justify-between">
                <h3 className="text-sm font-semibold text-gray-900">Pass Criteria</h3>
                <button
                    onClick={handleReset}
            ...
            <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                    <label className="text-xs font-medium text-gray-700">Min Trades</label>
                    <input
                        type="number"
                ...
                {/* Win Rate */}
                <div className="space-y-2">
                    <label className="text-xs font-medium text-gray-700">Win Rate (%)</label>
                    <input
                        type="number"
                ...
                {/* Profit Factor */}
                <div className="space-y-2">
                    <label className="text-xs font-medium text-gray-700">Profit Factor ($PF$)</label>
                    <input
                        type="number"
                ...
                <div className="space-y-2">
                    <label className="text-xs font-medium text-gray-700">Expected Value (R)</label>
                    <input
                        type="number"
                ...
                <div className="space-y-2 col-span-2">
                    <label className="text-xs font-medium text-gray-700">Net Profit (Total R)</label>
                    <input
                        type="number"
