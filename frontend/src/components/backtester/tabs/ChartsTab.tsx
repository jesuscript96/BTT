        ...
        <div className="flex flex-col h-full" style={{ borderRight: '1px solid var(--border)' }}>
          <div className="px-3 py-2 flex items-center">
            <span className="text-[10px] font-semibold text-[var(--color-ec-text-primary)] uppercase tracking-[0.12em] ml-8 inline-flex items-center gap-1">
              EV por Tiempo (30m)
              <span
                title="Esperanza Matemática (EV) promedio agrupada por la hora de entrada del trade (intervalos de 30 minutos). Sirve para identificar en qué franjas horarias las operaciones son rentables (barras verdes) o perdedoras (barras rojas) en promedio."
        ...
        <div className="flex flex-col h-full">
          <div className="px-3 py-2 flex items-center">
            <span className="text-[10px] font-semibold text-[var(--color-ec-text-primary)] uppercase tracking-[0.12em] ml-4 inline-flex items-center gap-1">
              EV por Dia
              <span
                title="Esperanza Matemática (EV) promedio por día de la semana de entrada. Ayuda a detectar si hay días específicos (como los lunes o viernes) en los que la estrategia rinde peor y convendría evitar operar."
                style={{ cursor: 'help', opacity: 0.6, fontSize: '8px', textTransform: 'none', letterSpacing: 'normal' }}
              >
                (?)
              </span>
        ...
        <div className="flex flex-col h-[280px]" style={{ borderRight: '1px solid var(--border)' }}>
          <div className="px-3 py-2">
            <span className="text-[10px] font-semibold text-[var(--color-ec-text-primary)] uppercase tracking-[0.12em] inline-flex items-center gap-1">
              ...
              <span
                title="Histograma de frecuencias que agrupa los trades según su rentabilidad porcentual final. Ideal para ver la simetría del sistema (ej: si tienes muchos trades con ganancias moderadas o si hay pérdidas extremas anormales)."
                style={{ cursor: 'help', opacity: 0.6, fontSize: '8px', textTransform: 'none', letterSpacing: 'normal' }}
              >
                (?)
              </span>
        ...
        <div className="flex flex-col h-[280px]" style={{ borderRight: '1px solid var(--border)' }}>
          <div className="px-3 pt-4 pb-1 flex items-center justify-between">
            <span className="text-[10px] font-semibold text-[var(--color-ec-text-primary)] uppercase tracking-[0.12em] ml-4 inline-flex items-center gap-1">
              Consecutive Runs
              <span
                title="Rachas Consecutivas. Muestra cuántas veces ocurrieron rachas seguidas de ganancias (verde) o pérdidas (rojo) de determinada longitud (1, 2, 3, etc. operaciones seguidas)."
                style={{ cursor: 'help', opacity: 0.6, fontSize: '8px', textTransform: 'none', letterSpacing: 'normal' }}
              >
                (?)
              </span>
        ...
        <div className="flex flex-col h-[280px]">
          <div className="py-2" style={{ paddingLeft: '40px' }}>
            <span className="text-[10px] font-semibold text-[var(--color-ec-text-primary)] uppercase tracking-[0.12em] inline-flex items-center gap-1">
              ...
              <span
                title="Estadísticas descriptivas detalladas de los retornos (PnL %) y rachas de victorias/pérdidas. Incluye medias, desviación estándar (volatilidad), asimetría (skewness) y curtosis (apuntamiento para detectar riesgo de black swan)."
                style={{ cursor: 'help', opacity: 0.6, fontSize: '8px', textTransform: 'none', letterSpacing: 'normal' }}
              >
                (?)
              </span>
