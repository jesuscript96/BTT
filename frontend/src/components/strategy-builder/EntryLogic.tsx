...
import { Plus, Trash2, GitBranch, ChevronRight, ChevronDown, Copy } from 'lucide-react';
                ...
                return (
                    <>
                        ...
                        <div className="flex items-center gap-2">
                            {/* Toggle between Indicator and Number - simplified for now, always Indicator for structure */}
                            <IndicatorInput
                                value={condition.target as IndicatorConfig} // simplificaction for MVP
        ...
        `}>
            ...
            <div className="flex items-center gap-3">
                <div className={`
                    ...
                    ${group.operator === 'AND' ? 'bg-blue-500/10 text-blue-500 hover:bg-blue-500/20' : 'bg-orange-500/10 text-orange-500 hover:bg-orange-500/20'}
                 `}
