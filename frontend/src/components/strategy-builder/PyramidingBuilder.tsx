                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: 6, flexWrap: 'wrap' }}>
                                ...
                                {lv.trigger === 'move' && (
                                    <>
                                        ...
                                        {esCamino(lv) ? (
                                            <span style={{ fontFamily: 'var(--color-ec-sans)', fontSize: 10, color: 'var(--color-ec-text-muted)' }}>y además el último paso del camino (dispara al cumplirse los dos)</span>
