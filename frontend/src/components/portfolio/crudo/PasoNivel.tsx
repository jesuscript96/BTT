      ...
      <Sec
        ...
        help={
          <>
            ...
            «sin X» (su parte repartida a las demás) y «todo a X». (Markowitz se probó y se quitó: mide el riesgo como
            varianza, y aquí la caída la hacen unos pocos días de cola, no el vaivén diario; su cartera de mínima varianza daba
            diez veces menos dinero con MÁS caída.)
            <br /><br />
