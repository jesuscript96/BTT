    ...
    >
      ...
      {rot.enabled && (
        <>
          ...
          <Row label="Por qué se ordena" help="Lo que se mira de cada estrategia en la ventana para ordenarlas. «Lo ganado por 1 %»: lo que aportó al portfolio por cada 1 % de tamaño, sumado en la ventana: la que más ganó por unidad, primera (premia a la que gana y opera a menudo; es lo que se midió: +17-35 % en tus PM). «EV por trade»: lo mismo dividido por sus trades: la calidad media de cada operación, sin premiar a la que opera más. «Sharpe»: lo ganado dividido por lo que oscila día a día: premia a la regular frente a la que gana a golpes (sube a la de poca volatilidad aunque gane menos; con tus PM fue peor). No es «la que ha mejorado más»: es «la que mejor lo ha hecho en la ventana».">
