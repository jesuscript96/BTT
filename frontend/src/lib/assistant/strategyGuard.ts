...
function normalizeIndicatorName(name: string): string {
    ...
    const LEGACY_MAP: Record<string, string> = {
        ...
        "acum. dollar volume": "Accumulated Dollar Volume",
        "acumulated dollar volume": "Accumulated Dollar Volume",
        ...
        "perfil de volumen": "Vol. de la franja",
        "vol. de la franja": "Vol. de la franja",
        "volumen de la franja": "Vol. de la franja",
        "punto de control": "Punto de control",
        "poc": "Punto de control",
        "nodo de arriba": "Nodo de arriba",
        "nodo superior": "Nodo de arriba",
        "nodo de abajo": "Nodo de abajo",
        "zona alta": "Zona alta",
        "zona baja": "Zona baja",
        "zona de valor": "Zona alta",
        "value area": "Zona alta",
        "nodo inferior": "Nodo de abajo",
        "rvol universo": "RVOL universo",
        "rvol del universo": "RVOL universo",
        "volumen relativo universo": "RVOL universo",
        "minutos desde el pico de volumen": "Minutos desde el pico de volumen",
        "minutos desde el pico": "Minutos desde el pico de volumen",
        "pendiente del volumen": "Pendiente del volumen",
        "aceleracion del volumen": "Pendiente del volumen",
        "ultimo pivote": "Ultimo pivote",
        "\u00faltimo pivote": "Ultimo pivote",
        "pivote": "Ultimo pivote",
        "pivot": "Ultimo pivote",
        "swing high": "Ultimo pivote",
        "swing low": "Ultimo pivote",
        "retroceso": "Retroceso (%)",
        "retracement": "Retroceso (%)",
        "pullback": "Retroceso (%)",
        "profundidad del retroceso": "Retroceso (%)",
        "absorption": "Absorption",
        "absorcion": "Absorption",
        "absorción": "Absorption",
        "muro": "Absorption",
        "wick ratio": "Wick Ratio",
        "ratio de mecha": "Wick Ratio",
        "mecha": "Wick Ratio",
        "absorption + wick": "Absorption + Wick",
        "absorcion + mecha": "Absorption + Wick",
        "absorción + mecha": "Absorption + Wick",
        "reg. slope": "Reg. Slope",
        "reg slope": "Reg. Slope",
        "slope": "Reg. Slope",
        "pendiente": "Reg. Slope",
        ...
        "extension atr": "ATR Extension",
        "extensión atr": "ATR Extension",
        "extension en atr": "ATR Extension",
        "time vs level": "Time vs Level",
        "tiempo sobre nivel": "Time vs Level",
        "tiempo por encima": "Time vs Level",
        "aceptacion": "Time vs Level",
        "aceptación": "Time vs Level",
        "rsi": "RSI",
        ...
        "señal macd": "MACD Signal",
        "senal macd": "MACD Signal",
        "macd histogram": "MACD Histogram",
        "macd histograma": "MACD Histogram",
        "histograma macd": "MACD Histogram",
